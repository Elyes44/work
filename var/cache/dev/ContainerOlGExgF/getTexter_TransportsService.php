...
class getTexter_TransportsService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        }, 1)))->fromStrings(['twilio' => 'twilio://'.$container->getEnv('string:TWILIO_ACCOUNT_SID').':'.$container->getEnv('string:TWILIO_AUTH_TOKEN').'@default?from='.$container->getEnv('string:TWILIO_FROM')]);
    }
}
